...
<div class="storybook-welcome">
  <h2>Welcome to the Orion Storybook</h2>
  <img src={ImageFile} />
</div>

This Storybook documents the components and the design system that is used in the Orion UIs.

For Orion Dashboard Developer Documentation, see [here](https://rancher.github.io/dashboard/home).
